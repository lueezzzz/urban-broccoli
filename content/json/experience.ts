...
export const experiences = [
  ...
  {
    company: "I AM Ready Review",
    logo: "IR",
    type: "Mobile Developer Intern",
    location: "Remote",
    roles: [
      {
        ...
        description: [
          "Spearheaded end-to-end development of a mobile crowdfunding application, designing and translating high fidelity wireframes into 3 core pages: Home, Profile, and Donor Portal.",
    ...
    roles: [
      {
        ...
        description: [
          "Engineered dynamic rendering for the faculty directory using JavaScript, cutting 1,000+ lines of hardcoded HTML and generating UI cards of 45+ staff across 5 distinct academic departments.",
        ...
        skills: ["HTML", "SCSS", "CSS", "Bootstrap 5", "JavaScript", "Git"],
      },
    ],
  },
